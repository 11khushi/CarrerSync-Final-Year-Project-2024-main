...
import MainLogo from '../images/Logo New.png'
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            ...
            <img src={MainLogo} className='mt-2 w-48' alt="Icon 02" />
            {/* <div className='text-[#6366f1] text-3xl font-bold mt-1'>
              CareerSync
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname === '/' || pathname.includes('visionvoult')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                            ...
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('visionvoult') ? 'text-indigo-500' : 'text-slate-400'
                                }`}
                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('visionvoult') ? 'text-indigo-600' : 'text-slate-600'
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('visionvoult') ? 'text-indigo-200' : 'text-slate-400'
                                }`}
                                d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"
                              />
                            </svg>
                            <NavLink to="visionvoult"
                             className={({ isActive }) =>
                ...
                {/* Job Board */}
                <SidebarLinkGroup activecondition={pathname.includes('job-post')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('job-post') ? 'text-indigo-600' : 'text-slate-700'}`}
                              ...
                              />
                              <path
                                className={`fill-current ${pathname.includes('job-post') ? 'text-indigo-500' : 'text-slate-600'}`}
                              ...
                              />
                              <path
                                className={`fill-current ${pathname.includes('job-post') ? 'text-indigo-300' : 'text-slate-400'}`}
              ...
              {/* |E-Commerce  */}
             <SidebarLinkGroup activecondition={pathname.includes('activejobs')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname.includes('activejobs') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('activejobs') ? 'text-indigo-300' : 'text-slate-400'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('activejobs') ? 'text-indigo-600' : 'text-slate-700'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('activejobs') ? 'text-indigo-500' : 'text-slate-600'}`}
